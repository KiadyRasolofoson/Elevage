                    ...
                    <tbody>
                        <?php foreach ($animaux as $animal) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= $base_url ?>/nourrir-animal/<?= $animal['id'] ?>" class="btn btn-warning btn-sm">Nourrir</a>
                                    <a href="<?= $base_url ?>/vendre-animal/<?= $animal['id'] ?>" class="btn btn-danger btn-sm">Vendre</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
