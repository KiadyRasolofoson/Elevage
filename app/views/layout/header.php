<?php
$indice = 0;
$nav = ['Home', 'Animals', 'Alimentation', 'Vendre', 'Dashboard', 'Nourriture', 'Tuer'];
$nav_link = ['/user', '/animal', '/alimentation', '/vente', '/dashboard', '/nourriture', '/mourrir'];
...
<head>
	...
	<link rel="stylesheet" href="<?= $base_url; ?>/public/assets/dash.css" />
...
<header class="header">
	<nav class="nav">
		...
		<?php } else { ?>
			<a class="button" href="<?php echo $base_url . "/disconnect"; ?>">Logout</a>
		<?php } ?>
	</nav>
</header>
